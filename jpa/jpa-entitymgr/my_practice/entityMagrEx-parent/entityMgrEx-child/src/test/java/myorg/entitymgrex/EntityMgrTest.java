...
//	@Test
    public void testFind() {
        ...
        //we need to associate the `em` with a transaction to get a primary key generated and assigned to the auto
        em.getTransaction().begin();
        em.getTransaction().commit();
...
//	@Test
    ...
    private int getMileage(long id) {
        ...
        Query query = em.createQuery("select a.mileage from Auto as a where a.id=:pk");
...
//    @Test
    public void testMerge() throws Exception {
        ...
        for(int mileage=(10*1000); mileage<(100*1000); mileage+=20000) {
            ...
            assertTrue("mileage was same", car.getMileage() != car2.getMileage());

            //commit the update to the database for query
            em.merge(car2);
            assertTrue("car1 not merged:" + car.getMileage(), car.getMileage() == mileage);
    ...
    public void testRemove() {
        ...
        //we need to associate the em with a transaction to physically remove from database
        em.getTransaction().begin();
        em.getTransaction().commit();
