...
/**
 * This class is an example of an entity that will be referenced from the parent
 * in its relationship through a Map which uses a value unique to that parent.
 */
@Entity
