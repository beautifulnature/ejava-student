...
/**
 * This class provides an example of a the owning entity of a one-to-one, uni-directional relationship where 
 * the dependent's primary key is derived from the parent, the parent uses a composite primary key, and the 
 * dependent used an `@EmeddedId` and `@MapsId`.
 */
@Entity
