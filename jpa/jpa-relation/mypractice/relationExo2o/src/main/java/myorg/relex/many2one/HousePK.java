...
/**
 * This class provides an example compound primary key value that will be used
 * in a many-to-one, uni-directional relationship.
 */
@Embeddable
public class HousePK implements Serializable {
	...
	public boolean equals(Object obj) {
		try {
			...
			if (street == null && rhs.street != null) {
				return false;
			}
