...
/**
 * This class provides an example of the owning/child side of a many-to-one,
 * uni-directional relationship where the parent uses a (embedded) compound
 * primary key.
 */
@Entity
...
public class Occupant {
	...
	@JoinColumns({ @JoinColumn(name = "RES_NUM", referencedColumnName = "NO"),
